        ...
        public MockNorthwind()
        {
            ...
            Territories = new List<Territory>
            {
                new Territory
                {
                    ...
                    EmployeeTerritories = new List<EmployeeTerritory> { EmployeeTerritories[0] }
                },
                new Territory
                {
                    TerritoryId = "01730", TerritoryDescription = "Bedford",
                    EmployeeTerritories = new List<EmployeeTerritory> { EmployeeTerritories[0], EmployeeTerritories[1] }
                },
                new Territory
                {
                ...
                new Territory
                {
                    ...
                    EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[2], EmployeeTerritories[3] }
                },
                new Territory
                {
                ...
                new Territory
                {
                    ...
                    EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[4], EmployeeTerritories[5] }
                },
                new Territory
                {
                ...
                new Territory
                {
                    ...
                    EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[6], EmployeeTerritories[7] }
                },
                new Territory
                {
                ...
                new Territory
                {
                    ...
                    EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[8] }
                },
            ...
            Employees = new List<Employee>
            {
                ...
                new Employee { EmployeeId = 2, LastName = "Fuller", FirstName = "Andrew", BirthDate = DateTime.Parse("1952-02-19"), HireDate = DateTime.Parse("1992-08-14"), City = "Tacoma", Country = "USA",
                  EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[1], EmployeeTerritories[2] } },
                ...
                new Employee { EmployeeId = 9, LastName = "Dodsworth", FirstName = "Anne", BirthDate = DateTime.Parse("1966-01-27"), HireDate = DateTime.Parse("1994-11-15"), City = "London", Country = "UK",
                  EmployeeTerritories = new List<EmployeeTerritory>{ EmployeeTerritories[8], EmployeeTerritories[9] } },
            };
